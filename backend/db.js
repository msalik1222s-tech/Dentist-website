...
function createPostgresDriver(connectionString) {
  ...
  const COLUMNS =
    "id, name, phone, service, date, time, message, status, source, created_at, updated_at";
      ...
      try {
        const { rows } = await query(
          `INSERT INTO appointments
             (id, name, phone, phone_digits, service, date, time, message, status, source, created_at)
